package com.popov.test.repository;

import com.popov.test.T02JhApp;
import com.popov.test.config.Constants;
import com.popov.test.config.audit.AuditEventConverter;
import com.popov.test.domain.PersistentAuditEvent;
...
import static com.popov.test.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
